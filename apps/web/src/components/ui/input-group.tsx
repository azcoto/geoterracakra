...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: This reusable layout primitive intentionally accepts arbitrary div content.
    <div
...
function InputGroupAddon({ className, align = 'inline-start', ...props }: React.ComponentProps<'div'> & VariantProps<typeof inputGroupAddonVariants>) {
  return (
    // biome-ignore lint/a11y/useSemanticElements: The addon is a presentational grouping inside the input primitive.
    // biome-ignore lint/a11y/useKeyWithClickEvents: The addon is not independently focusable; its click behavior only delegates focus to the input.
    <div
      role="group"
